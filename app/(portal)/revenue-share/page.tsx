  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <Card variant="stat" className="flex flex-col gap-2 animate-fade-in stagger-1">
        ...
        <Card variant="stat" className="flex flex-col gap-2 animate-fade-in stagger-2">
        ...
        <Card variant="stat" className="flex flex-col gap-2 animate-fade-in stagger-3">
      ...
      <Card>
        ...
        <div className="overflow-x-auto">
          <table className="w-full min-w-[540px] text-xs">
            ...
            <tbody>
              <tr className="border-b border-voro-muted-border hover:bg-voro-ghost transition-colors">
              ...
              <tr className="border-b border-voro-muted-border bg-voro-ghost/40 hover:bg-voro-ghost transition-colors">
              ...
              <tr className="bg-voro-ghost/40 hover:bg-voro-ghost transition-colors">
