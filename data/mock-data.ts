...
export const kpis = [
  { id: "k1", label: "Pending Commission",  value: "$48,200",  delta: "+$5,400 this month",  trend: "up"     },
  { id: "k2", label: "YTD Commission",      value: "$612,400", delta: "On track for $800K",   trend: "up"     },
  { id: "k3", label: "Active Deals",        value: "14",       delta: "3 closing this month", trend: "up"     },
  { id: "k4", label: "Action Items",        value: "7",        delta: "2 urgent",              trend: "down"   },
];
...
export const announcements = [
  { id: "a1", category: "Marketing",   cta: "Download",  title: "Q2 Brand Refresh Assets Live",             body: "New listing templates, buyer guide covers, and social media kits are now available in the asset library." },
  { id: "a2", category: "Operations",  cta: "Read more", title: "Updated Commission Disbursement Schedule",  body: "Starting May 1, commission payouts will process every Wednesday instead of bi-weekly. Review the updated policy." },
  { id: "a3", category: "Compliance",  cta: "Review",    title: "NY Fair Housing Disclosure Update Required", body: "All NY-licensed agents must complete the updated fair housing certification by June 30, 2026. Failing to comply may impact your license." },
];
...
export const academy = [
  ...
  { id: "ac2", title: "1031 Exchange Fundamentals",          type: "Workshop",     date: "Apr 29, 2026", time: "11:00 AM ET", duration: "90 min",   instructor: "David Chen",       description: "Understand identification rules, timelines, qualified intermediaries, and investor strategies.", tags: ["Investor", "Tax", "Exchange"],   enrolled: false, completed: false },
  { id: "ac3", title: "VORO Agent Portal Orientation",       type: "Self-Paced",   date: null,          time: null,         duration: "30 min",   instructor: "VORO Training Team", description: "Learn the portal from end to end: submitting deals, using services, and managing your profile.",  tags: ["Onboarding", "Portal"],          enrolled: true,  completed: true  },
